				...
				<div class="description">
					...
					<div class="bottom">
						<div class="description-3">
							...
							<p id="itemadded1" class="itemadded"></p>
						</div>
						<div class="description-4">
							<p>
								&nbsp &nbsp &nbsp;<i class='fas fa-concierge-bell'></i><span>FREE
						...
						<div class="atc-container">
							<form>
								...
								<a href="add-cart?id=${menuItem.id}">
									<button type="button" class="addcarts" value="Add to Cart">
